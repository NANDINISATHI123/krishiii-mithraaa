...
export const LogoIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const CloseIcon: React.FC<IconProps> = React.memo(({ className }) => (
  <Icon className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
  </Icon>
));

export const LogoutIcon: React.FC<IconProps> = React.memo(({ className }) => (
  <Icon className={className}>
...
export const AiIcon: React.FC<IconProps> = React.memo(({ className }) => (
  <Icon className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13 10V3L4 14h7v7l9-11h-7z" />
  </Icon>
));

export const SolutionIcon: React.FC<IconProps> = React.memo(({ className }) => (
  <Icon className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
  </Icon>
));

export const ArrowRightIcon: React.FC<IconProps> = React.memo(({ className = 'w-5 h-5' }) => (
  <Icon className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
  </Icon>
));

export const RainIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const CloudyIcon: React.FC<IconProps> = React.memo(({ className }) => (
    <Icon className={className}><path d="M17.5 16a4.5 4.5 0 100-9h-1.8a8 8 0 10-15.4 3.3A5.5 5.5 0 109.5 22h8a5 5 0 000-10z"/></Icon>
));

export const ThunderstormIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const PendingIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const BookmarkIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const SpeakerIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const MicrophoneIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const FeedbackIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const CallIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const MapIcon: React.FC<IconProps> = React.memo(({ className }) => (
...
export const ArrowLeftIcon: React.FC<IconProps> = React.memo(({ className }) => (
