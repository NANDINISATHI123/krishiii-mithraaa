...
const EmployeeDashboard = () => {
    ...
    const renderContent = () => {
        // Performance optimization: Using CSS to hide/show keeps component state
        // (like scroll position or data) alive when switching tabs, making the UI feel instant.
        return (
            <>
